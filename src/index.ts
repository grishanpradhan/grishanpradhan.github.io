        ...
        if (selectedFile){
            ...
            reader.onload = function(e){
                ...
                img.onload = async function(e){
                    ...
                    for(var i=1;i<colorRGBA.length;i++){
                    ...
                    const indexedDB = window.indexedDB || (window as any).mozIndexedDB || (window as any).webkitIndexedDB || (window as any).msIndexedDB || (window as any).shimIndexedDB;
